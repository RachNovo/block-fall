export default function HelpModal({ handleHelp, volume, volumeUp, volumeDown, musicTypeHandler, musicType }) {
            ...
            <div className='my-4 flex flex-col font-objectivityBold text-xs'>
                <div className="flex items-center text-grey mb-2">
                    ...
                    <div className='flex items-center space-x-2'>
                        <button className={`${volume > 0 ? 'hover:bg-hover-light-blue' : ''} text-grey border-dark-blue border-[2px] ml-1 px-2`} onClick={volumeDown}>-</button>
                        <div className="w-8 text-center">{volume}%</div>
                        <button className={`${volume < 100 ? 'hover:bg-hover-light-blue' : ''} text-grey border-dark-blue border-[2px] px-2`} onClick={volumeUp}>+</button>
                    </div>
                </div>
                <div className="text-grey mb-2 flex items-center space-x-2">
                    <div className="font-thin w-28">MUSIC TYPE</div>
                    <div className="w-20 text-center text-grey border-dark-blue border-[2px] mx-2 px-2 py-1 hover:bg-hover-light-blue" onClick={musicTypeHandler}>{musicType}</div>
                </div>
            </div>
